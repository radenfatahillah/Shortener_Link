    ...
    <div class="row">
      <div class="col-xl-8 order-xl-1">
        <div class="card">
          ...
          <div class="card-body">
          <form method="POST" action="{{route('admin.kelola_link.update', ['kelola_link' => $shortlink])}}">
              ...
              <div class="pl-lg-4">
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <a href="{{route('admin.kelola_link.index') }}" type="button" class="btn btn-sm btn-primary">Kembali</a>
